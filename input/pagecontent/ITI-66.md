...
The List Resources returned will be compliant with the [IHE restrictions on the List Resource](metadata_maps.html) and with the mapping of ebXML attributes to List elements to [SubmissionSet](metadata_maps.html#submissionSet) and to [Folder](metadata_maps.html#folder).
