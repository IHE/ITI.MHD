...
* action = #C
* subtype[iti105] = urn:ihe:event-type-code#ITI-105 "Simplified Publish Bundle"
...
* entity[documentReference].what = Reference(DocumentReference/ex-DocumentReferenceMinimal)
