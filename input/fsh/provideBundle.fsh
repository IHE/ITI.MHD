...
Profile:        SimplifiedPublishBundle
Parent:         Bundle
Id:             IHE.MHD.Simplified.PublishBundle
Title:          "MHD Simplified Publish Document Bundle"
Description:    "A profile on the Bundle transaction for ITI-105 Simplified Publish resources with minimal metadata for MHD.

- [Simplified Publish Bundle](StructureDefinition-IHE.MHD.Simplified.PublishBundle.html): `https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.Simplified.PublishBundle`
  - shall be a Transaction Bundle
  - all resources shall be compliant with minimal constraints, they may be marked minimal, comprehensive, or unContained
  - shall not include a SubmissionSet as that is derived off of the DocumentReference
  - shall create one [DocumentReference](StructureDefinition-IHE.MHD.Minimal.DocumentReference.html) that is either minimal, comprehensive, or unContained
  - shall create one [Binary](http://hl7.org/fhir/R4/binary.html)
  - shall not contain a [Folder type List](StructureDefinition-IHE.MHD.Minimal.Folder.html)
  - shall not contain a [Patient](http://hl7.org/fhir/R4/patient.html)"
* meta.profile 1..*
* implicitRules = "https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.Simplified.PublishBundle"
* type = #transaction
* entry ^slicing.discriminator[0].type = #profile
* entry ^slicing.discriminator[0].path = "resource"
* entry ^slicing.discriminator[1].type = #value
...
* entry[DocumentRefs].resource only 
    IHE.MHD.Minimal.DocumentReference 
* entry[DocumentRefs] ^short = "the DocumentReference resource"
* entry[DocumentRefs] ^definition = "one new DocumentReference that will be used to derive the SubmissionSet."
* entry[DocumentRefs].resource 1..1
* entry[DocumentRefs].request 1..1
* entry[DocumentRefs].request.method = #POST
* entry[Documents].resource ^type.code = "Binary"
