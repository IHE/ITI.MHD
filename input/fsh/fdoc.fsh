...
* subject = Reference(fdoc-patient)
* actualPeriod.start = "2013-01-20T12:30:02Z"
* actualPeriod.end = "2013-02-01T12:30:02Z"
* admission.dischargeDisposition.text = "Discharged to care of GP"
...
* status = #unknown
* intent = #order
* medication.concept = $sct#66493003
* medication.concept.text = "Theophylline 200mg"
* subject = Reference(fdoc-patient)
* requester = Reference(fdoc-practitioner)
* reason.concept.text = "Management of Asthma"
...
* status = #recorded
* reason.concept.text = "Management of Asthma"
* medication.concept.text = "Ventolin Inhaler"
* subject = Reference(fdoc-patient)
...
* reaction.manifestation.concept.text = "Hives"
