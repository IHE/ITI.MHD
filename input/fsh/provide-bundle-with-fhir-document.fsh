...
* content.profile.valueCoding = $formatcode#urn:ihe:iti:xds:2017:mimeTypeSufficient
* context.identifier.system = "https://www.example.org/encounters"
* context.identifier.value = "S100"
* facilityType = $sct#82242000
* practiceSetting = $sct#408467006
* contained[+] = aaaaaaaa-bbbb-cccc-dddd-e00888800004
* extension[sourcePatient].valueReference = Reference(aaaaaaaa-bbbb-cccc-dddd-e00888800004)
