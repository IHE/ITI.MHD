...
Description:    "Defines constraints on the Document Consumer AuditEvent Resource to record when a Retrieve Document Transaction happens.
* Import event
...
Title:          "Audit Event for Retrieve Document Transaction"
Description:    "Defines constraints on the Document Responder AuditEvent Resource to record when a Retrieve Document Transaction happens.
* Export event
* shall have a document consumer agent
* shall have a document responder agent
* may have user, app, organization agent(s)
