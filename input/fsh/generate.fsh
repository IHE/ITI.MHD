...
Instance: ex-input-doc-bundle
InstanceOf: MHDgenerateMetadataParametersIn
Description: "example Parameters with a Document Bundle"
Usage: #example
* parameter[document].name = "document"
* parameter[document].resource = ex-fhir-document-bundle
...
[ITI-106 Generate Metadata Request Message](ITI-106.html#2310641-generate-metadata-request-message)
...
* parameter[1].targetProfile[+] = Canonical(IHE.MHD.Minimal.DocumentReference)
* parameter[1].documentation = """
[ITI-106 Generate Metadata Response Message](ITI-106.html#2310642-generate-metadata-response-message)
