...
@ECHO "Done with publisher, starting validator"
@POWERSHELL -command (new-object System.Net.WebClient).DownloadFile(\"https://fhir.github.io/latest-ig-publisher/org.hl7.fhir.validator.jar\",\"input-cache\org.hl7.fhir.validator.jar\")
@ECHO "Done"
@PAUSE